...
// NewArticlesGetRequest generates requests for ArticlesGet
func NewArticlesGetRequest(server string, params *ArticlesGetParams) (*http.Request, error) {
	var err error
	...
	if params != nil {
		...
		if params.PublishYear != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "publish-year", runtime.ParamLocationQuery, *params.PublishYear); err != nil {
				return nil, err
...
func (r ArticlesGetResponse) Status() string {
...
func (r ArticlesGetResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
func ParseArticlesGetResponse(rsp *http.Response) (*ArticlesGetResponse, error) {
